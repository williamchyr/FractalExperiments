...
#ifndef LSystem3D_003_SphereTurtle_h
#define LSystem3D_003_SphereTurtle_h
...
public:
    ...
    void init( Vec3f startPosition, Vec3f basisRotation, Vec3f objectRotation, float radius, bool wireframe, float r, float g, float b);
    void init( Vec3f startPosition, Matrix44<float> rotationMatrix, Vec3f objectRotation, float radius, bool wireframe, float r, float g, float b);
